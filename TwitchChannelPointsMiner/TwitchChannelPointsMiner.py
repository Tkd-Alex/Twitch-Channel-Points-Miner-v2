...
class TwitchChannelPointsMiner:
    ...
    def analytics(self, host: str = "127.0.0.1", port: int = 5000, refresh: int = 5, baseurl: str = ""):
        http_server = AnalyticsServer(host=host, port=port, refresh=refresh, baseurl=baseurl)
