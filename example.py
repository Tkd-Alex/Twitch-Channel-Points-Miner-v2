...
twitch_miner.mine(
    [
        ...
        Streamer("streamer-username06", settings=StreamerSettings(make_predictions=True, bet=BetSettings(strategy=Strategy.KELLY, max_points= 25000))),
        Streamer("streamer-username07", settings=StreamerSettings(make_predictions=True, bet=BetSettings(strategy=Strategy.KELLY_FRACTIONAL, percentage=50,max_points= 25000))),
