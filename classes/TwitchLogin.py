            ...
            while True:
                ...
                if 'error_code' in login_response:
                    ...
                    if err_code == 3011 or err_code == 3012:  # missing 2fa token
                        if err_code == 3011:
                            logger.info('Two factor authentication enabled, please enter token below.')
                        else:
                        ...
                        if err_code == 3022:
                            ...
                            logger.info('Invalid Login Verification code entered, please try again.')
                        ...
                        logger.info('Console login unavailable (CAPTCHA solving required).')
