...
twitch_miner = TwitchChannelPointsMiner(
    ...
    refresh_context=60,                       # Refresh the streamers list (followers and .json file) each x minutes
...
You streamers's settings will be stored `streamers_json="settings.json"`. You can also edit the file on runtime. Each `refresh_context` the script will check for Followers update (if set to True) and new settings from .json file. Read more about: [StreamerSettings](#streamersettings)
