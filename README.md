...
### Replit
Run a new Replit with the master branch:
...
Official Replit with description and added keep-alive functionality: https://replit.com/@rdavydov/Twitch-Channel-Points-Miner-v2
